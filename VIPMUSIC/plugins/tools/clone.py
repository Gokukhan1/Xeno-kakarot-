...
from Goku.utils.database import get_assistant
from config import API_ID, API_HASH
from Goku import app
from Goku.misc import SUDOERS
from Goku.utils.database import get_assistant, clonebotdb
